                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txtProvinsi" onchange="provChange()">
                                    <option v-for="prov in provinsiData" v-bind:value="prov.id_prov"></option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                        <div class="form-group">
                                ...
                                <select class="form-control" id="txtKabupaten" onchange="kabChange()">
                                    <option v-for="kab in kabupatenData" v-bind:value="kab.id_kab"></option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                        <div class="form-group">
                                ...
                                <select class="form-control" id="txtKecamatan" onchange="kecChange()">
                                    <option v-for="kec in kecamatanData" v-bind:value="kec.id_kec"></option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                          <div class="form-group">
                                  ...
                                  <select class="form-control" id="txtKelurahan" onchange="kelChange()">
                                      <option v-for="kd in kelurahanData" v-bind:value="kd.id_kel"></option>
                                  </select>
                              </div>
                        </div>
                    </div>
