<footer>
                            ...
                            <div class="widget-footer mt-30">
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="widget-blog-wrap">
                                            <div class="widget-blog-image">
                                                <a href="#"><img src="{{ asset('ladun/futala/') }}/images/blog/small-blog.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="widget-blog-wrap">
                                            <div class="widget-blog-image">
                                                <a href="#"><img src="{{ asset('ladun/futala/') }}/images/blog/small-blog-02.jpg" alt=""></a>
                                            </div>
                                            <div class="widget-blog-content">
    ...
    <!-- Slick Slider JS -->
    <script src="{{ asset('ladun/futala/') }}/js/plugins/slick.min.js"></script>
    <!--  Jquery ui JS -->
    <script src="{{ asset('ladun/futala/') }}/js/plugins/jqueryui.min.js"></script>
    <!--  Scrollup JS -->
    <script src="{{ asset('ladun/futala/') }}/js/plugins/scrollup.min.js"></script>
