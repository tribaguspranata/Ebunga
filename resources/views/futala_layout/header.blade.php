...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('ladun/futala/') }}/css/style.css">
    <!--<link rel="stylesheet" href="{{ asset('ladun/futala/') }}/css/style.min.css">-->
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="shop.html">Product</a>
                                            <ul class="mega-menu">
                                                ...
                                                @php
                                                    $subKategori = DB::table('tbl_sub_kategori') -> where('kd_kategori', $kategori -> kd_kategori) -> get();
                                                @endphp
                                                <li style="padding-bottom: 12px;padding-left:12px;"><a href="#!">{{ $kategori -> nama_kategori }}</a>
                                                    <ul>
                                    ...
                                    <ul class="mini-cart">
                                        <li class="cart-item">
                                            <div class="cart-image">
                                                <a href="product-details.html"><img alt="" src="{{ asset('ladun/futala/') }}/images/product/product-01.jpg"></a>
                                            </div>
